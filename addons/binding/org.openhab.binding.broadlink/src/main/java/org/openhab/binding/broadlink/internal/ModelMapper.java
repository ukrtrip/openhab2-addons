...
public class ModelMapper {
    ...
    public static ThingTypeUID getThingType(int model) {
        ...
        if (model == 0x947a || model == 0x9479)
            return BroadlinkBindingConstants.THING_TYPE_SP3S; // NB: this is ACTUALLY an SP3S - see https://github.com/mjg59/python-broadlink/blob/master/broadlink/__init__.py
        if (model == 0x2728)
